...
export default {
    ...
    teamIntro: {
        ...
        subtitle:
            "Professional data analysis team dedicated to providing accurate data prediction services",
        mission: {
            title: "Our Mission",
            description:
                "Providing precise and reliable data analysis and prediction services through advanced AI technology",
        },
        technology: {
